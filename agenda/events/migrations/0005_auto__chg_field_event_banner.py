...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.banner'
        db.alter_column('events_event', 'banner', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Event.banner'
        db.alter_column('events_event', 'banner', self.gf('django.db.models.fields.files.ImageField')(default=None, max_length=100))
    ...
    models = {
        ...
        'events.event': {
            ...
            'banner': ('django.db.models.fields.files.ImageField', [], {'default': 'None', 'max_length': '100', 'null': 'True'}),
