...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.announced'
        db.add_column(u'events_event', 'announced',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.announced'
        db.delete_column(u'events_event', 'announced')
    ...
    models = {
        ...
        u'events.event': {
            ...
            'banner': ('django.db.models.fields.files.ImageField', [], {'default': 'None', 'max_length': '100', 'null': 'True', 'blank': 'True'}),
