...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column('events_event', 'banner')

        # Deleting field 'Event.spotlight'
        db.delete_column('events_event', 'spotlight')
    ...
    models = {
        ...
        'events.event': {
            ...
            'banner': ('django.db.models.fields.files.ImageField', [], {'default': 'None', 'max_length': '100'}),
